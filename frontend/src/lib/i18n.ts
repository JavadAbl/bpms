...
export const t = {
  ...
  // Report builder (v7) — keys used by report-builder.tsx (builder UI) and
  // reports-view (landing page). UPPERCASE status keys stay dynamic-lookup safe.
  ...
  instanceDataGroup: 'داده‌های پرونده',
  processVarsGroup: 'متغیرهای فرآیند',
  processVarsHint: 'متغیرهای تعریف‌شده و فیلدهای فرم‌های این فرآیند',
  noVariables: 'متغیری برای این فرآیند ثبت نشده است',
  selectedColumns: 'ستون‌های انتخابی',
  selectedColumnsHint: 'ترتیب نمایش ستون‌ها به ترتیب انتخاب است',
  statusFilter: 'وضعیت نمونه',
  dateRangeFilter: 'بازه تاریخ شروع',
  dateFrom: 'از تاریخ',
  dateTo: 'تا تاریخ',
  variableFilters: 'فیلتر متغیر',
  addVariableFilter: 'افزودن فیلتر متغیر',
  variableName: 'متغیر',
  filterValue: 'مقدار',
  opEq: 'برابر باشد با',
  opNeq: 'متفاوت باشد از',
  opContains: 'شامل باشد',
  previewReport: 'پیش‌نمایش',
  previewResult: 'نتیجه پیش‌نمایش',
  createReport: 'ایجاد گزارش',
  editReport: 'ویرایش گزارش',
  reportSaved: 'گزارش ذخیره شد',
  noReportColumns: 'حداقل یک ستون انتخاب کنید',
  selectProcessFirst: 'ابتدا یک فرآیند انتخاب کنید',
  reportNeedsProcess: 'انتخاب فرآیند الزامی است',
