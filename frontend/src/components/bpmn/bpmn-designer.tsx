...
// Re-export for convenience — the constant itself lives in default-bpmn-xml.ts
// so it can be imported without pulling the designer chunk.
export { DEFAULT_BPMN_XML };
