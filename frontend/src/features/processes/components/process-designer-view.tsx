...
const BpmnDesigner = dynamic(
  () => import('@/features/processes/components/bpmn/bpmn-designer').then((m) => m.BpmnDesigner),
  { ssr: false, loading: () => <Skeleton className="h-full w-full rounded-none" /> },
);
const FormBuilderPanel = dynamic(
  () => import('@/features/processes/components/form-builder-panel').then((m) => m.FormBuilderPanel),
  { ssr: false },
);
const TaskAssignmentModal = dynamic(
  () => import('@/features/processes/components/task-assignment-modal').then((m) => m.TaskAssignmentModal),
  { ssr: false },
);
const ProcessStartersModal = dynamic(
  () => import('@/features/processes/components/process-starters-modal').then((m) => m.ProcessStartersModal),
  { ssr: false },
);
const ProcessVersionsDialog = dynamic(
  () => import('@/features/processes/components/process-versions-dialog').then((m) => m.ProcessVersionsDialog),
  { ssr: false },
);
const GatewayConditionModal = dynamic(
  () => import('@/features/processes/components/gateway-condition-modal').then((m) => m.GatewayConditionModal),
  { ssr: false },
);
