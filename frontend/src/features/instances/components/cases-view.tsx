...
export function CasesView({ onViewInstance }: Props) {
  ...
  // Deep-link seam: /cases?start=<processId|1> opens the start dialog
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-2xl font-bold">{t.myCases}</h2>
          {!isAdmin && (
            <Badge variant="secondary" className="text-xs">
              پرونده‌هایی که در آن‌ها وظیفه دارید یا شروع کرده‌اید
            </Badge>
          )}
        </div>
